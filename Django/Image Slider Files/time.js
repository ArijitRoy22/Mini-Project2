...
const customStartTimes = [
  new Date().getTime() + (1 * 60 * 1000), // Example: 1 minute from now
  // new Date("May 7, 2024").getTime(),
  new Date().getTime() + (1 * 60 * 1000),
  new Date().getTime() + (2 * 60 * 1000), // Change to 2 minutes from now for card 3
  new Date().getTime() + (4 * 60 * 1000), // Example: 4 hours from now
